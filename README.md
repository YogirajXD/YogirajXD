# Hi, I'm Yogirajsinh Bhosale 👋

### AI/ML & Data Science Developer | Computer Vision • NLP • Agentic AI
...
- 🎯 **Current Goal:** Open to developer/engineering internships and junior roles in AI/ML and Data Science.
...
| **AI & Machine Learning** | `PyTorch` • `TensorFlow` • `Scikit-learn` • `YOLO` • `OpenCV` • `MediaPipe` |
| **Data & Analytics** | `Pandas` • `NumPy` • `MySQL` • `PostgreSQL` • `MongoDB` • `Excel` • `Tableau` • `Power BI` |
| **Development & Tools** | `Node.js` • `HTML5` • `CSS3` • `Git` • `GitHub` |
...
- 🧠 **Agentic AI & LLM Systems:** Multi-agent architectures, reasoning loops, and AI engineering workflows.
